...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.cover'
        db.add_column(u'common_userinfo', 'cover',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.photo'
        db.add_column(u'common_userinfo', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.cover'
        db.delete_column(u'common_userinfo', 'cover')

        # Deleting field 'UserInfo.photo'
        db.delete_column(u'common_userinfo', 'photo')
