...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.parent'
        db.add_column(u'common_userinfo', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MedintUser'], null=True),
                      keep_default=False)

        # Adding field 'YubiKey.creator'
        db.add_column(u'common_yubikey', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_key', null=True, to=orm['common.MedintUser']),
                      keep_default=False)

        # Adding field 'YubiKey.parent'
        db.add_column(u'common_yubikey', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='child_key', null=True, to=orm['common.MedintUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.parent'
        db.delete_column(u'common_userinfo', 'parent_id')

        # Deleting field 'YubiKey.creator'
        db.delete_column(u'common_yubikey', 'creator_id')

        # Deleting field 'YubiKey.parent'
        db.delete_column(u'common_yubikey', 'parent_id')
    ...
    models = {
        ...
        u'common.userinfo': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.MedintUser']", 'null': 'True'}),
        ...
        u'common.yubikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child_key'", 'null': 'True', 'to': u"orm['common.MedintUser']"}),
