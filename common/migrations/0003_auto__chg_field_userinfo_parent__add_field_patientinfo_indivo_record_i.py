...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.parent'
        db.alter_column(u'common_userinfo', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MedintUser'], null=True, on_delete=models.SET_NULL))
        # Adding field 'PatientInfo.indivo_record_id'
        db.add_column(u'common_patientinfo', 'indivo_record_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PatientInfo.doctor'
        db.add_column(u'common_patientinfo', 'doctor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MedintUser'], null=True),
                      keep_default=False)


        # Changing field 'MedintUser.user_info'
        db.alter_column(u'common_medintuser', 'user_info_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, on_delete=models.SET_NULL, to=orm['common.UserInfo']))

        # Changing field 'YubiKey.parent'
        db.alter_column(u'common_yubikey', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['common.MedintUser']))

    def backwards(self, orm):

        # Changing field 'UserInfo.parent'
        db.alter_column(u'common_userinfo', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MedintUser'], null=True))
        # Deleting field 'PatientInfo.indivo_record_id'
        db.delete_column(u'common_patientinfo', 'indivo_record_id')

        # Deleting field 'PatientInfo.doctor'
        db.delete_column(u'common_patientinfo', 'doctor_id')


        # Changing field 'MedintUser.user_info'
        db.alter_column(u'common_medintuser', 'user_info_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['common.UserInfo']))

        # Changing field 'YubiKey.parent'
        db.alter_column(u'common_yubikey', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['common.MedintUser']))
