...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiscussionAccess'
        db.create_table(u'messaging_discussionaccess', (
            ...
            ('access_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1969, 12, 31, 0, 0))),
        ))
        db.send_create_signal(u'messaging', ['DiscussionAccess'])


    def backwards(self, orm):
        # Deleting model 'DiscussionAccess'
        db.delete_table(u'messaging_discussionaccess')
