...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'messaging_messagefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['messaging.DiscussionMessage'])),
        ))
        db.send_create_signal(u'messaging', ['MessageFile'])


    def backwards(self, orm):
        # Deleting model 'MessageFile'
        db.delete_table(u'messaging_messagefile')
    ...
    models = {
        ...
        u'messaging.messagefile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['messaging.DiscussionMessage']"})
        }
    }
