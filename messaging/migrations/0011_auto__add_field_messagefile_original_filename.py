...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageFile.original_filename'
        db.add_column(u'messaging_messagefile', 'original_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageFile.original_filename'
        db.delete_column(u'messaging_messagefile', 'original_filename')
