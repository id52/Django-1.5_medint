...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'messaging_contactitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['common.MedintUser'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='in_contacts', to=orm['common.MedintUser'])),
        ))
        db.send_create_signal(u'messaging', ['ContactItem'])


    def backwards(self, orm):
        # Deleting model 'ContactItem'
        db.delete_table(u'messaging_contactitem')
