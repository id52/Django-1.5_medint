...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'messaging_message', (
            ...
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_messages', to=orm['common.MedintUser'])),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('deleted_by_recipient', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted_by_sender', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        u'messaging.message': {
            ...
            'deleted_by_recipient': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'received_messages'", 'to': u"orm['common.MedintUser']"}),
            'send_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
