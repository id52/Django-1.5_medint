...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscussionMessage.file_message_id'
        db.add_column(u'messaging_discussionmessage', 'file_message_id',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MessageFile.file_message_id'
        db.add_column(u'messaging_messagefile', 'file_message_id',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscussionMessage.file_message_id'
        db.delete_column(u'messaging_discussionmessage', 'file_message_id')

        # Deleting field 'MessageFile.file_message_id'
        db.delete_column(u'messaging_messagefile', 'file_message_id')
