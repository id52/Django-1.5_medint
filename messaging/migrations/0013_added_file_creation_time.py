...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageFile.upload_time'
        db.add_column(u'messaging_messagefile', 'upload_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageFile.upload_time'
        db.delete_column(u'messaging_messagefile', 'upload_time')
