...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageFile.thumbnail'
        db.add_column(u'messaging_messagefile', 'thumbnail',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'MessageFile.upload_time'
        db.alter_column(u'messaging_messagefile', 'upload_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'MessageFile.thumbnail'
        db.delete_column(u'messaging_messagefile', 'thumbnail')


        # Changing field 'MessageFile.upload_time'
        db.alter_column(u'messaging_messagefile', 'upload_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'messaging.discussionaccess': {
            ...
            'access_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)'}),
        ...
        u'messaging.discussionmessage': {
            ...
            'discussion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['messaging.Discussion']"}),
            'file_message_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
