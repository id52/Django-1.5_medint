...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageFile.mime_type'
        db.add_column(u'messaging_messagefile', 'mime_type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'MessageFile.message'
        db.alter_column(u'messaging_messagefile', 'message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['messaging.DiscussionMessage'], null=True))

        # Changing field 'MessageFile.file'
        db.alter_column(u'messaging_messagefile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'MessageFile.mime_type'
        db.delete_column(u'messaging_messagefile', 'mime_type')


        # User chose to not deal with backwards NULL issues for 'MessageFile.message'
        raise RuntimeError("Cannot reverse this migration. 'MessageFile.message' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MessageFile.file'
        raise RuntimeError("Cannot reverse this migration. 'MessageFile.file' and its values cannot be restored.")
    ...
    models = {
        ...
        u'messaging.messagefile': {
            'Meta': {'object_name': 'MessageFile'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['messaging.DiscussionMessage']", 'null': 'True'}),
