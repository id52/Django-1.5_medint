  ...
  document.onkeydown = function(event)
    {
	   if(String.fromCharCode(event.keyCode) == "M")
        {
            if(renderer.forceColored_ == false && renderer.forceXRay == false)
            {
                renderer.forceColored_ = true;
            }
            else if(renderer.forceColored_ == true && renderer.forceXRay == false)
            {
                renderer.forceColored_ = false;
                renderer.forceXRay = true;
            }
            else if(renderer.forceColored_ == false && renderer.forceXRay == true)
            {
                renderer.forceXRay = false;
            }
        }
        if(String.fromCharCode(event.keyCode) == "B")
        {
            if(alpha == true)
            {
                renderer.toggleAlphaOn();
                alpha = false;
            }
            else
            {
                renderer.toggleAlphaOff();
                alpha = true;
            }
        }
    }
